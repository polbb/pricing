...
with st.container(border=True):
    ...
    if data:
        ...
        fig.update_layout(title_text='Notice Percentage Distribution Plot', width=400, height=300)  # Adjusted size
        st.plotly_chart(fig, use_container_width=True)  # Plot inside the container
